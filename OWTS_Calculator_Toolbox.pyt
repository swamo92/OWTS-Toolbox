...
#
# To load this toolbox into ArcGIS simply right-click the ArcToolbox icon and navigate to where the .pyt file is
# stored. More information on Python toolboxes can be found at 
...
# septic system type from the 'Septic_Sys' field in the 'CTown_OWTS.shp'.
...
# Clip Tool used to clip selected data to the area of interest, in the example use 'CHA_SAMP.shp'.
